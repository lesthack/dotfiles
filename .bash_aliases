...
alias me_bajarmp3="youtube-dl -v -x --add-metadata --embed-thumbnail --audio-format mp3"
...
alias me_snap_update="sudo snap refresh"
alias me_update_all="me_apt_update && me_flatpack_update && me_snap_update"
